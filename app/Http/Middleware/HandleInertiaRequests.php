...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        return array_merge(parent::share($request), [
            ...
            'locale' => [
                'current' => fn() => LocaleManager::resolve($request->user()),
                'app' => fn() => app()->getLocale(),
                'frontend' => fn() => LocaleManager::toFrontendLocale(LocaleManager::resolve($request->user())),
                'available' => fn() => LocaleManager::available(),
                'switch_route' => fn() => route('locale.update'),
                'currency' => 'BRL',
    ...
    public function getPermissions()
    {
        ...
        $permissions['contact_center_dashboard_view'] = userCheckPermission('contact_center_dashboard_view');
        $permissions['contact_center_settings_view'] = userCheckPermission('contact_center_settings_view');
        $permissions['contact_center_settings_edit'] = userCheckPermission('contact_center_settings_edit');
        $permissions['contact_center_agents_manage'] = userCheckPermission('contact_center_agents_manage');
        $permissions['contact_center_queues_manage'] = userCheckPermission('contact_center_queues_manage');
        $permissions['dialer_view'] = userCheckPermission('dialer_view');
        $permissions['dialer_manage'] = userCheckPermission('dialer_manage');
        $permissions['dialer_run'] = userCheckPermission('dialer_run');
        $permissions['dialer_campaign_manage'] = userCheckPermission('dialer_campaign_manage');
