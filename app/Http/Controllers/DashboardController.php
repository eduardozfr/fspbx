...
class DashboardController extends Controller
{
    ...
    public function getCounts()
    {
        ...
        if (Route::has('contact-center.index') && (userCheckPermission("contact_center_settings_edit") || userCheckPermission("contact_center_dashboard_view"))) {
    ...
    public function getApps()
    {
        ...
        if (Route::has('dialer.index') && userCheckPermission('dialer_view')) {
            $dialerApp = ['name' => 'Dialer', 'href' => route('dialer.index'), 'icon' => 'PhoneOutgoingIcon', 'slug' => 'dialer'];

            if (userCheckPermission('dialer_manage')) {
                $dialerApp['alt_href'] = route('dialer.index');
                $dialerApp['alt_link_label'] = 'Settings';
            }
