...
class SetUpUserSession
{
    ...
    public function handle(Login $event)
    {
        ...
        $resolvedLocale = Session::has('locale')
            ? LocaleManager::normalize(Session::get('locale'))
            : LocaleManager::resolve($event->user);
        ...
        if (!is_null($menu_uuid)) {
            ...
            $_SESSION['domain']['language']['code'] = LocaleManager::toDatabaseLocale($resolvedLocale);
