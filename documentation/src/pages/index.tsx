...
export default function Home(): ReactNode {
    ...
    const features = [
        ...
        },
        {
            ...
            description: 'FS PBX includes bundled Call Center and Dialer modules for queue supervision, lead management, and automated outbound campaigns. Telecom-focused extensions like STIR/SHAKEN can still be layered on when needed.',
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer:
                'FS PBX extends FusionPBX with capabilities that are now bundled directly into this repository, including Call Center queue supervision and a multi-mode outbound Dialer. These enhancements make FS PBX a more feature-rich solution for modern VoIP operations while keeping the platform familiar for existing FreeSWITCH teams.',
        },
        {
    ...
    const tiers = [
        ...
        },
        {
            ...
            features: ['3 hours of support', 'Phone or email', 'Feature development', 'Call Center and Dialer included'],
            featured: false,
            mostPopular: false,
        },
        {
            ...
            features: [
                ...
                'Feature development',
                'Call Center and Dialer included',
                'Custom integrations',
            ],
            featured: true,
            mostPopular: true,
                ...
                <main>
                    ...
                    <div className="py-24 sm:pt-48">
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            ...
                            <div className="mt-2"><p className="text-sm text-gray-600"> * Optional support subscription</p></div>
                            ...
                            <div className="mt-16 flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 dark:ring-gray-700 bg-white dark:bg-gray-900/80 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center transition-colors">
                                <div className="lg:min-w-0 lg:flex-1">
                                    <h3 className="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">
                                        Call Center and Dialer Modules
                                    </h3>
                                    <p className="mt-1 text-base/7 text-gray-600 dark:text-gray-300">
                                        This repository now bundles Call Center queue management and Dialer campaigns, including manual, preview, progressive, and power workflows.
                                    </p>
                                </div>
