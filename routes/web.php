...
if (file_exists(base_path('Modules/CallCenter/routes/web.php'))) {
    require base_path('Modules/CallCenter/routes/web.php');
}

if (file_exists(base_path('Modules/Dialer/routes/web.php'))) {
    require base_path('Modules/Dialer/routes/web.php');
}
