...
class DatabaseSeeder extends Seeder
{
    ...
    private function createGroups()
    {
        ...
        $groups = [
            ...
            [
                ...
                'group_protected'   => 'true',
                'group_level'       => 50,
                'group_description' => "Contact center supervisors can manage queues, agents, and wallboards",
                'insert_date'       => date("Y-m-d H:i:s"),
            ],
            [
                ...
                'group_protected'   => 'true',
                'group_level'       => 30,
                'group_description' => "Contact center agents can access live queue dashboards and dialer workflows",
                'insert_date'       => date("Y-m-d H:i:s"),
            ],
            [
                'group_name'        => 'Dialer Manager',
                'group_protected'   => 'true',
                'group_level'       => 40,
                'group_description' => "Dialer managers can configure and run outbound dialing campaigns",
                'insert_date'       => date("Y-m-d H:i:s"),
            ],
    ...
    private function createPermissions()
    {
        $permissions = [
            ...
            ['application_name' => 'Contact Center', 'permission_name' => 'contact_center_dashboard_view'],
            ['application_name' => 'Contact Center', 'permission_name' => 'contact_center_settings_view'],
            ['application_name' => 'Contact Center', 'permission_name' => 'contact_center_settings_edit'],
            ['application_name' => 'Contact Center', 'permission_name' => 'contact_center_agents_manage'],
            ['application_name' => 'Contact Center', 'permission_name' => 'contact_center_queues_manage'],
            ['application_name' => 'Contact Center', 'permission_name' => 'contact_center_reports_view'],
            ['application_name' => 'Dialer', 'permission_name' => 'dialer_view'],
            ['application_name' => 'Dialer', 'permission_name' => 'dialer_manage'],
            ['application_name' => 'Dialer', 'permission_name' => 'dialer_run'],
            ['application_name' => 'Dialer', 'permission_name' => 'dialer_campaign_manage'],
        ];
    ...
    private function createGroupPermissions()
    {
        $permissionsByGroup = [
            'superadmin' => [
                ...
                'contact_center_settings_view',
                'contact_center_settings_edit',
                'contact_center_agents_manage',
                'contact_center_queues_manage',
                'contact_center_reports_view',
                'dialer_view',
                'dialer_manage',
                'dialer_run',
                'dialer_campaign_manage',
            ],
            'admin' => [
                'wakeup_calls_list_view',
                'wakeup_calls_create',
